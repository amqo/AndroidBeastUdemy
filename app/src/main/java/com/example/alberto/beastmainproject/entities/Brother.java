...
public class Brother implements Parcelable {
    ...
    public Brother(int brotherId, String brotherName, String brotherWhyJoin, String brotherPicture,
                   String brotherMajor, String brotherCrossSemester, String brotherFunFact) {
